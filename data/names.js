...
window.TK.factions = {
  han:  { th: "ฮั่น (จ๊กก๊ก)", py: "Shu-Han", color: "#2E9E5B" },
  wei:  { th: "วุ่ยก๊ก",       py: "Wei",      color: "#2563A8" },
  wu:   { th: "ง่อก๊ก",        py: "Wu",       color: "#C2413A" },
  none: { th: "ไม่มีเจ้าของ",  py: "Neutral",  color: "#9AA0A6" }
};

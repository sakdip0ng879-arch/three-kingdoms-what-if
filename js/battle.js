...
TK.battle = (function(){
  ...
  function goPhase(n, instant){
    ...
    if (n < phase || n > phase + 1){
      ...
      /* ป้ายและเอฟเฟกต์ของทุกระยะที่เพิ่งเล่นย้อนมาต้องถูกล้าง ไม่งั้นคนที่กดข้ามไประยะท้าย ๆ
         จะเห็นป้ายของทุกระยะก่อนหน้ากองรวมกัน และเห็นวงล้อมค้างอยู่รอบเมืองที่ยอมแพ้ไปแล้ว

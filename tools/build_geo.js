...
const GROW = Number(process.argv[2] || 110);
/* ความคลาดเคลื่อนตอนลดจุด (หน่วยแผนที่)
   ค่านี้กินขอบเข้ามาด้วย ตั้งไว้ 7 แล้ววัดจากภาพจริงได้ 98.3% ทั้งที่ตารางบอก 99.1%
   ส่วนต่างคือเสี้ยวขาวบาง ๆ ตามขอบ — ลดลงมาที่ 4 แล้วชดเชยที่เหลือด้วย stroke ใน CSS */
const DPTOL = 4;
